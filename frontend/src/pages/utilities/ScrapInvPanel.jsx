      ...
      if (legacyMode) {
        try {
          ...
          if (storesHandle) {
            ...
            if (perm === "granted") {
              const wb = XLSX.utils.book_new()
              XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet([HEADERS, ...importedRows.map(i => COLUMNS.map(k => i[k] ?? ""))]), "SCRAP INV")
              ...
              const fh = await td.getFileHandle("tbl_ScrapInv.xlsm", { create: true })
