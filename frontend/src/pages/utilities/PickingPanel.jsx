      ...
      if (legacyMode) {
        try {
          ...
          if (storesHandle) {
            ...
            if (perm === "granted") {
              const wb = XLSX.utils.book_new()
              XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet([["ITEM"], ...importedRows.map(i => [i.item_no])]), "ITEM FOR PICK")
              ...
              const fh = await td.getFileHandle("tbl_ItemPicking.xlsm", { create: true })
