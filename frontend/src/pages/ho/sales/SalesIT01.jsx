  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
      <div className="bg-blue-500 px-4 py-2 flex items-center justify-between">
        <span className="text-white font-bold">IT01</span>
...
export default function SalesIT01() {
  ...
  const parseMut = useMutation({
    mutationFn: () => salesApi.parseSalesData({ raw_tsv_it01: tsv }),
    onSuccess: (res) => setPreview(res.data.it01),
  })
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm space-y-3">
        ...
        <textarea
          ...
          placeholder="Incolla qui i dati IT01 copiati da Navision..."
          rows={6}
        ...
        <button
          ...
          disabled={!tsv || parseMut.isPending}
        ...
        >
          <Upload size={16} />
          {parseMut.isPending ? "Elaborazione..." : "Analizza IT01"}
        </button>
      </div>
