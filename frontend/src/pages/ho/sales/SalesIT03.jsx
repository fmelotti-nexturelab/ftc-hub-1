  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
      <div className="bg-violet-500 px-4 py-2 flex items-center justify-between">
        <span className="text-white font-bold">IT03</span>
...
export default function SalesIT03() {
  ...
  const parseMut = useMutation({
    mutationFn: () => salesApi.parseSalesData({ raw_tsv_it03: tsv }),
    onSuccess: (res) => setPreview(res.data.it03),
  })
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm space-y-3">
        ...
        <textarea value={tsv} onChange={(e) => setTsv(e.target.value)} placeholder="Incolla qui i dati IT03 copiati da Navision..." rows={6}
        ...
        <button onClick={() => parseMut.mutate()} disabled={!tsv || parseMut.isPending}
          ...
          <Upload size={16} />
          {parseMut.isPending ? "Elaborazione..." : "Analizza IT03"}
        </button>
      </div>
