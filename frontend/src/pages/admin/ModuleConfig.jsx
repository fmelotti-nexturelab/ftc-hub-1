...
const CONFIGURABLE_TYPES = ["HR", "FINANCE", "MARKETING", "IT", "COMMERCIAL", "DM", "STORE"]
        ...
        <table className="text-xs w-full">
          <thead>
            ...
            <tr className="bg-gray-50 border-b border-gray-200 text-gray-400">
              ...
              {CONFIGURABLE_TYPES.map((t) => (
                <>
                  <th key={`${t}-v`} className="px-2 py-1 text-center font-normal">Visualizza</th>
                  <th key={`${t}-g`} className="px-2 py-1 text-center font-normal">Gestisci</th>
                </>
              ))}
            </tr>
          </thead>
            ...
            {modules.map((module) => (
              ...
              >
                ...
                {CONFIGURABLE_TYPES.map((user_type) => {
                  ...
                  return (
                    <>
                      <td key={`${user_type}-v`} className="px-2 py-2.5 text-center">
                      ...
                      <td key={`${user_type}-g`} className="px-2 py-2.5 text-center">
                        <div className="flex justify-center">
                          <Toggle
