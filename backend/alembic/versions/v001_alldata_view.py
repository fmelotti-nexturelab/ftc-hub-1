"""create ho.v_alldata view — ItemList + promo + BF + eccezioni + flags + stock IT01/02/03

Revision ID: v001_alldata_view
Revises: s002_stock_items_desc_text
Create Date: 2026-04-28
"""
from alembic import op

revision = "v001_alldata_view"
down_revision = "s002_stock_items_desc_text"
branch_labels = None
depends_on = None
